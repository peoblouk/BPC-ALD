...
typedef long TSetElement;				///< Definice typu SetElement
#define TSET_ELEMENT_FRMSTR "%ld"		///< Definice formátovacího řetězce pro souborové operace s typem SetElement

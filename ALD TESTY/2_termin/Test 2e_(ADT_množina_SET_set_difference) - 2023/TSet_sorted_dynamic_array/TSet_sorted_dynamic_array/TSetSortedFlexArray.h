#ifndef TSET_SORTED_FLEX_ARRAY_H
#define TSET_SORTED_FLEX_ARRAY_H
/** \file TSetSortedFlexArray.h
 *  \brief Deklarace typu SetSortedFlexArray a jeho API pro realizaci množiny pomocí setříděného flexibilního dynamicky alokovaného pole
 *  \author Petyovský
 *  \version 2024
 *  $Id: TSetSortedFlexArray.h 2711 2024-04-12 16:58:56Z petyovsky $
 */
...
/** \defgroup TSetSortedFlexArray 2.1. SetSortedFlexArray
 *  \brief Deklarace typu SetSortedFlexArray a jeho funkcí (pro realizaci množiny pomocí setříděného flexibilního dynamicky alokovaného pole)
 *  \ingroup TSet
 *  \{
 */

/** \brief Deklarace privátního typu SetSortedFlexArray
 */
struct TSetSortedFlexArray;
//typedef size_t TSetSortedFlexArrayPos;	///< Definice typu pro pozici v SetSortedFlexArray
 ...
 *  \retval -1 Pokud element nebyl v poli nalezen a hledaná hodnota elementu je menší, než hodnota na pozici \p *aPosPtr
 *  \retval  0 Pokud element byl v poli nalezen a hledaná hodnota elementu je na pozici \p *aPosPtr
 *  \retval +1 Pokud element nebyl v poli nalezen a hledaná hodnota elementu je větší, než hodnota na pozici \p *aPosPtr
...
#endif /* TSET_SORTED_FLEX_ARRAY_H */

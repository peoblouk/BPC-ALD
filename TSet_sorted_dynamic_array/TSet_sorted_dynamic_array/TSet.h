...
#define TSET_H
/** \file TSet.h
 *  \brief Definice typu Set - (realizace množiny pomocí setříděného flexibilního dynamicky alokovaného pole)
 *  \author Petyovský
 *  \version 2024
 *  $Id: TSet.h 2703 2024-04-12 15:38:04Z petyovsky $
 */
...
/** \defgroup TSet 2. Set
 *  \brief Definice datového typu Set a jeho funkcí (realizace množiny pomocí setříděného dynamicky alokovaného pole)
 *  \{
 */

/** \brief Definice typu Set
 *  \details Typ Set obsahuje setříděné pole prvků typu SetElement a umožňuje s nimi pracovat pomocí definovaného API.
 */
struct TSet
	{
